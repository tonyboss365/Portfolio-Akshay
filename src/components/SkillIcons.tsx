...
export const SKILL_ICONS: Record<string, React.ReactNode> = {
  ...
  "LeetCode": (
    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none">
      <path d="M16.102 17.93l-2.69 2.6c-.462.447-1.21.447-1.672 0l-7.86-7.6c-.462-.447-.462-1.17 0-1.618l7.86-7.6c.463-.447 1.21-.447 1.673 0l2.69 2.6c.463.448.463 1.17 0 1.618L10.37 12l5.733 5.541c.463.447.463 1.17 0 1.618z" fill="#FFA116" />
      <path d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2s10 4.477 10 10z" stroke="#FFA116" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  ),
  "CodeChef": (
    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none">
      <path d="M21 16.5c0-.83-.67-1.5-1.5-1.5h-.18c.36-.59.58-1.27.58-2 0-2.21-1.79-4-4-4-.28 0-.55.04-.81.1-.88-1.84-2.77-3.1-4.99-3.1-2.22 0-4.11 1.26-4.99 3.1-.26-.06-.53-.1-.81-.1-2.21 0-4 1.79-4 4 0 .73.22 1.41.58 2h-.18C1.67 15 1 15.67 1 16.5c0 .76.57 1.38 1.31 1.48C2.65 19.98 5.6 22 9.5 22s6.85-2.02 7.19-4.02c.74-.1 1.31-.72 1.31-1.48z" fill="#5B4636" />
    </svg>
  )
};
